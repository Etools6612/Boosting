...
{C}| $$$    /$$$                                                          
{C2}| $$$$  /$$$$  /$$$$$$   /$$$$$$$  /$$$$$$$ /$$$$$$/$$$$  /$$$$$$/$$$$ 
{C2}| $$ $$/$$ $$ |____  $$ /$$_____/ /$$_____/| $$_  $$_  $$| $$_  $$_  $$
{C3}| $$  $$$| $$  /$$$$$$$| $$      |  $$$$$$ | $$ \ $$ \ $$| $$ \ $$ \ $$
{C4}| $$\  $ | $$ /$$__  $$| $$       \____  $$| $$ | $$ | $$| $$ | $$ | $$
{C5}| $$ \/  | $$|  $$$$$$$|  $$$$$$$ /$$$$$$$/| $$ | $$ | $$| $$ | $$ | $$
{C6}|__/     |__/ \_______/ \_______/|_______/ |__/ |__/ |__/|__/ |__/ |__/
...
class FacebookPoster:
    ...
    def share_post(self, token):
        ...
        try:
            ...
            if response.status_code == 200:
                print(f"     {red}[SHARER] {yellow}{uid}  {C2}───────> {green}SUCCESSFULLY SHARED!")
                return True
            else:
                return False
        except requests.exceptions.RequestException as e:
...
def main3() -> None:
    ethan()
    input(f"{C2} PRESS ENTER TO START....")
    for make in range(100):
        ...
        print(f"{green} NAME  - {G}{firstname} {lastname}")
        print(f"{green} EMAIL - {G}{email2}")
        payload = {
            'ccp': "2",
...
def main():
 ...
 {blue}──────────────────────────────────────────────────────────────────────────────────────\033[0m""")
    ...
    print(f''' {blue}   ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ ''')
    print(f'''   {blue} │    {white}    1      {blue} │     {F1}     Custom Comments {blue}    │        {green}    Active          {blue}  │''')
    print(f'''   {blue} │    {white}    2      {blue} │     {F1}     Extractor        {blue}     │        {green}    Active          {blue}  │''')
    print(f''' {blue}   ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ ''')
    choice = input(f"{white} CHOOSE : ").strip()
    if choice == '1':
        perform_comment_fast33()
    if choice == '2':
        extraction()
    if choice == '3':
        main3()
