...
def main2(): 
 ...
 {green}─────────────────────────────────────────────────────────────────\033[0m""")
    ...
    print(f"     {yellow}[2] {blue} AUTOMATIC SHARE")
...
def main():
    ...
    print(f"          {Q}○ {lightblue}3/C {white}Reaction FAST {blue}           ◆{Z1} Page or Account {RW}      {RW} ")
    print(f"          {Q}○ {lightblue}4/D {white}Reaction Reels/Video  {blue}     ◆{Z1} Account {RW}              {RW} ")
    ...
    print(f"          {Q}○ {lightblue}7/D {white}Follower Page or profile   {blue}     ◆{Z1} Account {RW}              {RW} ")
    print(f"                                                                    {RW} ")
    print(f"                                                                    {RW} ")
