...
""")
ll=str([hari,tanggal])
hx=(f"""  [bold green_yellow]DEVELOPER[medium_purple1]   ⟩ [bold red] Kristel
  [bold red]FACEBOOK[medium_purple1]    ⟩ [bold cyan1] Kristel Mae
  [bold red]STATUS[medium_purple1]      ⟩ [bold cyan1] ACTIVE until feb 28, 2030
  [bold red]TELEGRAM[medium_purple1]    ⟩ [bold cyan1] N/A
  [bold red]TOOL[medium_purple1]        ⟩ [bold cyan1] Paided
  [bold red]INFO[medium_purple1]        ⟩ [bold cyan1] PREMIUM 
  [bold red]RELEASE #[medium_purple1]   ⟩ [bold cyan1] 9
  [bold red]FAQ.[medium_purple1]        ⟩ [bold cyan1] LIMITED EDITION 
