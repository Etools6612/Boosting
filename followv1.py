...
def main():
    ...
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}   {Q}○ {lightblue}7/K {white}Followers V1       {blue}      ◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}   {Q}○ {lightblue}8/L {white}Followers Page/Profile   {blue}◆{Z1} Page or Account {RW}{BG}        {RW} ")
    print(f"       {BG}                                                             {RW} ")
    print(f"       {BG}                                                             {RW} ")
