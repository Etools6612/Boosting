...
║ {rb}              ╩ ╩╩ ╩╩═╝╩ ╚═╩ ╩╩ ╩ ╩ ╚═╝╩ ╩╩ ╩                {DD}║
{DD}╠════════════════════════════════╦═════════════════════════════╝ """)
    print(f"║{YY} IP Address : {C} {get_ip()}  {DD} ║ memory usage {rb} {red} 64{white} bit ")
    print(f"║{YY} Time       : {C} {get_time()}        {DD} ║ Network {rb}Wifi Or Data    ")
    print(f"║{YY} Date       : {C} {get_date()}{DD}║ Used :  {red} Pc{white} or {red}Phone   ")
    print(f"║{YY} User info  : {C} NYS | CAS      {DD}  ║ {red}no by pass     ")
    print(f"║{YY} Uses       :  {C}Boosting         {DD}║ {white}System {green} Updated    ")
...
def main():
    ...
    print(f"""               
  {DD}╔════════════════════════════════════════════╗\033[0m
  {DD}║   {Q7}FRA ACCOUNT{yellow} : {green}{total_accounts}                         {DD} ║
 {DD} ║   {Q7}FRA PAGES  {yellow} : {green}{total_pages}                         {DD} ║
{DD}  ║   {Q7}RPW ACCOUNT{yellow} : {green}{total_account_rpw}                      {DD}    ║
  {DD}║   {Q7}RPW PAGES  {yellow} : {green}{total_pages_rpw}                       {DD}   ║
 {DD} ╠════════════════════════════════════════════╝\033[0m""")
    print(f"  {DD}│ ")
    print(f" {DD} ├──  {YY}𝐂𝐨𝐥𝐮𝐦𝐧 1 ")
    print(f"  {DD}├──  {WW} {white}𝐓𝐨𝐨𝐥 𝐌𝐚𝐢𝐧 𝐌𝐞𝐧𝐮  {RW} ")
    print(f"  {DD}│        ├── {YY}1. {C}Facebook account {W}extraction ")
    print(f"{DD}  │        ├── {YY}2.{C} Live Account{W} Checker ")
    print(f"  {DD}│        ├── {YY}3. {C}Reset {W}Tool ")
    print(f" {DD} │        ├── {YY}4.{C} Update {W}Tool ")
    print(f"  {DD}│           ")
    print(f"  {DD}├──  {YY}𝐂𝐨𝐥𝐮𝐦𝐧 2 ")
    print(f" {DD} ├──  {WW} {white}𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧   {RW}")
    print(f"  {DD}├──  {CQ}𝐓𝐨𝐨𝐥 𝐒𝐞𝐫𝐯𝐢𝐜𝐞 ( 📂 )")
    print(f"  {DD}│        ├── {YY}5. {C}Automatic Reaction{W}Fast ")
    print(f"  {DD}│        ├── {YY}6. {C}Automatic Reaction {W}Slow ")
    print(f"  {DD}│        ├── {YY}7. {C}Automatic Reaction {W}Reel/Video ")
    print(f" {DD} │        ├── {YY}{YY}8. {C}Automatic Reaction {W}Group Post ")
    print(f"  {DD}│        ├── {YY}9. {C}Automatic Reaction  On Going {W}Live ")
    print(f"  {DD}│        ├──{YY} 10. {C}Automatic Reaction {W}Comments ")
    print(f"  {DD}│           ")
    print(f"  {DD}├──  {YY}𝐂𝐨𝐥𝐮𝐦𝐧 3 ")
    print(f"  {DD}├──  {WW} {white}𝐂𝐮𝐬𝐭𝐨𝐦 𝐂𝐨𝐦𝐦𝐞𝐧𝐭  {RW} ")
    print(f"  {DD}├──  {CQ}𝐓𝐨𝐨𝐥 𝐒𝐞𝐫𝐯𝐢𝐜𝐞 ( 📂 )")
    print(f"  {DD}│        ├── {YY}11. {C}Custom {W}Comment ")
    print(f"  {DD}│        ├── {YY}12. {C}Custom Comment On going{W} live ")
    print(f"  {DD}│        ├── {YY}13. {C} Custom Reply{W} Comment  ")
    print(f"  {DD}│           ")
    print(f"  {DD}├──  {YY}𝐂𝐨𝐥𝐮𝐦𝐧 4 ")
    print(f"  {DD}├──  {WW} {white}𝐅𝐨𝐥𝐥𝐨𝐰𝐞𝐫   {RW}")
    print(f" {DD} ├──  {CQ}𝐓𝐨𝐨𝐥 𝐒𝐞𝐫𝐯𝐢𝐜𝐞 ( 📂 )")
    print(f"  {DD}│        ├── {YY}14. {C}Automatic{W} Followers ")
    print(f"  {DD}│        ├── {YY}15. {C}Automatic Follower {W}Page {C}Or {W}profile ")
    print(f"  {DD}│        ├── {YY}16. {C}Page {W}Likes {C}and {W}Follower  ")
    print(f"  {DD}│           ")
    print(f"  {DD}├──  {YY}𝐂𝐨𝐥𝐮𝐦𝐧 5 ")
    print(f"  {DD}├──  {WW} {white}𝐒𝐡𝐚𝐫𝐞  {RW}  ")
    print(f"  {DD}├──╮ {CQ}𝐓𝐨𝐨𝐥 𝐒𝐞𝐫𝐯𝐢𝐜𝐞 ( 📂 )")
    print(f"  {DD}│  │     ├── {YY}17. {C}Automatic Share {W}Fast ( bot ) ")
    print(f"  {DD}│  │     ├── {YY}18. {C}Automatic Share {W}slow ( Token ) ")
    print(f"  {DD}│  │     ├── {YY}19. {C}Page {W}Likes {C}and {W}Follower  ")
    print(f"  {DD}│  │          ")
    print(f"  {DD}├──╯ {YY}𝐂𝐨𝐥𝐮𝐦𝐧 6 ")
    print(f"  {DD}├──  {WW} {white}𝐎𝐭𝐡𝐞𝐫𝐬   {RW}")
    print(f"  {DD}├──╮ {CQ}𝐓𝐨𝐨𝐥 𝐒𝐞𝐫𝐯𝐢𝐜𝐞 ( 📂 )")
    print(f"  {DD}│  │     ├── {YY}20. {C}Token {W}Getter ")
    print(f"  {DD}│  │     ├── {YY}21. {C}Facebook Mass {W}Report ")
    print(f"  {DD}│  │     ├── {YY}22. {C}Facebook Story {W}Views  ")
    print(f"  {DD}│  │     ├── {YY}23. {C}Auto Create {W}fb account ")
    print(f"  {DD}│  │     ├── {YY}24. {C} Tiktok {W}Views  ")
    print(f"  {DD}│  │     ├── {YY}25. {C} Fb Views {W}Views  ")
    print(f"  {DD}│  │     ├── {YY}26. {C}Token check ( Acc Removed )   ")
    print(f"  {DD}│  │     ├── {YY}27. {C} Duplicate account {W}checker ")
    print(f"  {DD}│  │     │      ")
