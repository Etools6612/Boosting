...
|_______/  \______/  \______/ |_______/    \___/  
    ...
    {BG}                                                             {BG}{RW}
    {BG}                    {Z1}DEVELOPER :{RW} {blue}Admin{BG}                   {RW}
    {BG}                                                             {RW}
    {BG}  {red} ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{BG}   {RW} """)
...
def main():
    ...
    print(f'''    {BG}{Z2}  4  {red}    │ {Z5}01  {Q}Add Facebook Account Version 1                {RW} ''')
    print(f'''    {BG}{Z2}  5 {red}     │ {Z5}02 {Q} Auto Reaction Without Care      {Z1}•             {RW} ''')
    print(f'''    {BG}{Z2}  6 {red}     │ {Z5}03 {Q} Auto Reaction With Care         {Z1}•             {RW} ''')
    print(f'''    {BG}{Z2}  7 {red}     │ {Z5}04  {Q2}Auto Reaction Comment           {Z1}•             {RW} ''')
    print(f'''    {BG}{Z2}  8{red}      │ {Z5}05  {Q2}Auto Reaction DP / COVER        {Z1}•             {RW} ''')
    print(f'''    {BG}{Z2}  9{red}      │ {Z5}06  {Q2}Auto Reaction Reels             {Z1}•             {RW}  ''')
    print(f'''    {BG}{Z2}  10 {red}    │{Z5} 07  {Q3}Auto Followers                  {Z1}•             {RW}  ''')
    print(f'''    {BG}{Z2}  12 {red}    │{Z5} 08  {Q3}Custom Comment                  {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  13{red}     │{Z5} 09  {Q4}Custom Comment " Reels "        {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  14 {red}    │{Z5}.10  {Q4}Custom Comment " DP "           {Z1}•             {RW}  ''')
    print(f'''    {BG}{Z2}  15 {red}    │{Z5}.11  {Q5}Auto Reply Comment              {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  16{red}     │{Z5}.12 {Q5} Auto Share V1                   {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  17{red}     │{Z5}.13 {Q6} Stored Page and Account         {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  18 {red}    │{Z5}.14  {Q6}❝ Mass Facebook Report ❞        {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  18 {red}    │{Z5}.15  {Q6}Auto React V2        {Z1}•             {RW}  ''')     
    print(f'''    {BG}{Z2}  19  {red}   ╰───────────────────────────────────{Z5}  ヂ            {RW} ''')
    linex()
